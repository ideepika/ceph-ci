...
class TestVolumes(CephFSTestCase):
    ...
    def test_subvolume_snapshot_clone_cancel_pending(self):
        ...
        NR_CLONES = 5
        # yeh, 1GB -- clones would be canceled anyway
        FILE_SIZE_MB = 1 * 1024
        ...
        # do some IO
        self._do_subvolume_io(subvolume, number_of_files=64, file_size=FILE_SIZE_MB)
        ...
        slice_count = NR_CLONES - NR_THREADS
        to_wait = clones[0:-slice_count]
        to_cancel = clones[-slice_count:]
